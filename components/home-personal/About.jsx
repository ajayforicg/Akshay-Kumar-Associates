        ...
        <div className="row lg-marg">
          <div className="col-lg-5 valign">
            <div className="profile-img">
              <div className="img">
                <img src="/assets/imgs/header/image 21.png" alt="" />
              </div>
              <span className="icon">
                <img src="/assets/imgs/resume/Law.png" alt="" />
              </span>
              <span className="icon">
                <img src="/assets/imgs/resume/Law Book.png" alt="" />
              </span>
              <span className="icon">
                <img src="/assets/imgs/resume/Scales.png" alt="" />
              </span>
              <span className="icon">
                <img src="/assets/imgs/resume/Law Book.png" alt="" />
              </span>
